...
import { formatCurrency, getLastMonthRange, filterExpensesByDateRange, calculateTotalExpenses, exportToCSV } from '@/lib/utils';
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
        ...
        <div className="flex gap-2">
          <Button variant="secondary" onClick={() => exportToCSV(expenses)}>
            <svg
